										...
										<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
											<!-- <div class="tab_img">
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika1.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika1.jpg" class="img-responsive" alt="Party 1">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika2.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika2.jpg" class="img-responsive" alt="Party 2">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika3.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika3.jpg" class="img-responsive" alt="Party 3">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika5.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika5.jpg" class="img-responsive" alt="Party 4">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika6.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika6.jpg" class="img-responsive" alt="Party 5">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika7.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika7.jpg" class="img-responsive" alt="Party 7">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika8.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika8.jpg" class="img-responsive" alt="Party 8"/>
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="col-md-3 img-top grid_box">
														<a href="images/galerija/slika4.jpg" class="swipebox"  title="Image Title">
															  <img src="images/galerija/slika4.jpg" class="img-responsive" alt="Party 4">
															  <span class="zoom-icon"></span> 
														</a>
													</div>
													<div class="clearfix"></div>	
											...
											<div class="tab_img">
												<?php
													if($konekcija)
													{
														$rezultat = $konekcija->query("SELECT * FROM galerija");
														// var_dump($rezultat);

														foreach($rezultat as $red)
														{
															echo "<div class='col-md-3 img-top grid_box'>
															<a href='images/galerija/$red->src' class='swipebox'  title='$red->alt'>
																  <img src='images/galerija/$red->src' class='img-responsive' alt='$red->alt'>
																  <span class='zoom-icon'></span> 
															</a>
														</div>";
														}
	...
	<div class="footer-section" id="contact" id="contact">
			...
			<div class="contact">
				<form>
					...
					<div id="sendmsg" class="col-md-4 contactgrid2">
